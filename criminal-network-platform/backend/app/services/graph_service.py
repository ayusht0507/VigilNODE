...
class GraphService:
    ...
    # ============================================================
    # CLEAR GRAPH (CASE-SCOPED)
    # ============================================================

    def clear_case_graph(self, case_id: str) -> None:
        """
        Safely clears only the nodes and relationships belonging to a specific case,
        preserving all other cases in the graph.
        """
        if not case_id:
            return
    ...
    def clear_graph(self) -> None:
        """
        Global clear (used only for system resets).
        """
        with self._driver.session() as session:
